# Mirrorscript
Script to change official Kali repository to mirrors. This helps increase packages update and downloading for some user. Please visit my blog [post]().
...
## Help
```
# python3 mirrorscript.py -h
usage: mirrorscript.py [-h] [-v] [-https] [-src]

Kali Mirrorscripts automatically select the best kali mirror
...
## Sample output:
```
# python3 mirrorscript.py -v -https -src
